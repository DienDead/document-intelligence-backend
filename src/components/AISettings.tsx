...
import { togetherAI } from "@/lib/together-client"
...
export default function AISettings() {
  ...
  useEffect(() => {
    ...
    const hasApiKey = !!import.meta.env.VITE_TOGETHER_API_KEY
    setIsConfigured(hasApiKey)
    if (hasApiKey) {
      setApiKey("••••••••••••••••")
      setModel(import.meta.env.VITE_TOGETHER_MODEL || "meta-llama/Llama-2-70b-chat-hf")
    }
  }, [])
  ...
  const testConnection = async () => {
    setTesting(true)
    try {
      const isConnected = await togetherAI.testConnection()
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Configure Together AI settings for document Q&A</CardDescription>
      </CardHeader>
            ...
            <AlertDescription>
              <div className="space-y-2">
                ...
                <ol className="list-decimal list-inside space-y-1 text-sm">
                  ...
                  <li>Add VITE_TOGETHER_API_KEY to your .env file</li>
                  <li>Optionally set VITE_TOGETHER_MODEL for a specific model</li>
